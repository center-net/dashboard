...
<nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    ...
    <div class="text-left navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="<?php echo e(url('/dashboard')); ?>"><img src="<?php echo e(URL::asset('assets/images/logo-dark.png')); ?>" alt=""></a>
        <a class="navbar-brand brand-logo-mini" href="<?php echo e(url('/dashboard')); ?>"><img src="<?php echo e(URL::asset('assets/images/logo-icon-dark.png')); ?>"
                alt=""></a>
    ...
    <ul class="nav navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown ">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-big dropdown-notifications">
                <div class="dropdown-header notifications">
                    <strong><?php echo e(trans('Sidebar_trans.Notifications')); ?></strong>
        ...
        <li class="nav-item dropdown mr-30">
            <a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button"
                ...
                <img src="<?php echo e(URL::asset('assets/images/user_icon.png')); ?>" alt="avatar">
...
<!--=================================
header End-->
<?php /**PATH E:\laravel\dashboard\resources\views/layouts/main-header.blade.php ENDPATH**/ ?>