<div class="container-fluid">
    <div class="row">
                ...
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#dashboard">
                            <div class="pull-left"><i class="ti-home"></i><span class="right-nav-text">العامل البشري</span>
                            </div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="dashboard" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="/employees"><i class="ti-menu-alt"></i><span class="right-nav-text">الموظفين</span></a> </li>
                            <li> <a href="/customers"><i class="ti-menu-alt"></i><span class="right-nav-text">العملاء</span></a> </li>
                            <li> <a href="/suppliers"><i class="ti-menu-alt"></i><span class="right-nav-text">الموردين</span></a> </li>
                        </ul>
                    </li>
                    <!-- menu title -->
        ...
        <!--=================================
<?php /**PATH E:\laravel\dashboard\resources\views/layouts/main-sidebar.blade.php ENDPATH**/ ?>